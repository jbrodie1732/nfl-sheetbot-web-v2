...
// components/LeaderboardTable.tsx (reload on 'sheetmeat:profile-updated')
'use client'
    ...
    <div className="lb">
      <table>
        <thead>
          <tr>
            <th>#</th>
            <th onClick={()=>onSort('nickname')}>Player</th>
            {mode==='week' && <th>Week</th>}
            <th onClick={()=>onSort('wins')}>W</th>
            <th onClick={()=>onSort('pushes')}>P</th>
            <th onClick={()=>onSort('losses')}>L</th>
            <th onClick={()=>onSort('points')}>Pts</th>
          </tr>
        </thead>
        <tbody>
          {sorted.map((r, i)=> {
